...
| Verification | `launching-iisexpress` release contract | Detects canonical template drift and stale or forged generated launchers using dependency-free PowerShell, release provenance, and reconstructed full-body SHA-256 fingerprints | `.github/skills/launching-iisexpress/Verify-LaunchingIISExpress.ps1` |
| Validation | `launching-iisexpress` regressions | Executes the rendered launcher under Windows PowerShell or PowerShell 7 to verify root and virtual-path mappings, provenance and body validation, and safe substitution without external modules | `.github/skills/launching-iisexpress/Verify-LaunchingIISExpress.Tests.ps1` |
