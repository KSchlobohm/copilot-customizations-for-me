...
| Verification | `launching-iisexpress` release contract | Detects canonical template drift and stale generated IIS Express launch scripts using release version plus a normalized SHA-256 fingerprint | `.github/skills/launching-iisexpress/verify.mjs` |
